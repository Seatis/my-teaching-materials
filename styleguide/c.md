# C coding style
This is a short document describing our preferred coding style. Coding style is very personal, but it's useful to keep some simple general rules. You may have heard of **clean code principles**. This document is created to a certain extent according to clean code principles.
So lets start with some general recommendations.
