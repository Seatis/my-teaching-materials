...
public class TestHorse {
    ...
    public void testToString() throws Exception {
        String expected = String.format("Horse(super=AbstractAnimal(name=Paci, birthDate=%s, children=[], movedDistanceInMilliMeters=0, happiness=2300.0, weightInGram=100000))"
