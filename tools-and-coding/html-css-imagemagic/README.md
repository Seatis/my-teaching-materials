# HTML & CSS
Create small layouts with HTML and CSS, and proceeding with small image manipulation tasks using ImageMagic.

## Objectives
 - Using classes and ids
 - Understanding sizes and the box-model in CSS
 - Using borders
 - Create an animated gif using ImageMagic

## Materials & Resources
### Environment
#### ImageMagic
 - Please download and install from: http://www.imagemagick.org/script/binary-releases.php
...
#### Create 4 pictures of yourself
 - Create pictures with your webcam or phone and save the images in a directory

#### Crop the images to have squared images
 - Using image magic command line tool crop the images, to center your face: http://www.imagemagick.org/Usage/crop/

#### Scale the images to be 200x200 pixels
